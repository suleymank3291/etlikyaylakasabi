...
export default function Hero() {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-neutral-900">
      ...
      <div className="absolute inset-x-0 top-1/2 -translate-y-[68%] flex flex-col items-center text-center px-6 pointer-events-none">
        <p
          className="text-white/60 text-xs font-black tracking-[0.3em] uppercase mb-5"
          style={{ fontFamily: "var(--font-josefin, sans-serif)" }}
        >
          {SITE.sehir}
        </p>
        <h1
          className="text-white font-serif text-5xl md:text-7xl lg:text-[6.5rem] max-w-4xl leading-[1.05] tracking-tight"
        >
          {HERO.baslik}
        </h1>
        <p className="text-white/75 text-base md:text-xl mt-6 max-w-lg leading-relaxed">
          {HERO.altMetin}
        </p>
      </div>
